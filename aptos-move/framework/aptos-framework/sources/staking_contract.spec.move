spec aptos_framework::staking_contract {
    ...
    spec set_beneficiary_for_operator(operator: &signer, staker: address, new_beneficiary: address) {
        // TODO: temporary mockup
        pragma verify = false;
    }

    spec set_beneficiary_for_operator_internal(operator: address, staker: address, new_beneficiary: address) {
        // TODO: temporary mockup
        pragma verify = false;
    }

    spec beneficiary_for_operator(staker: address, operator: address): address {
        // TODO: temporary mockup
        pragma verify = false;
    }
