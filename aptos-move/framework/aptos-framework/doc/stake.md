...
-  [Resource `Beneficiary`](#0x1_stake_Beneficiary)
...
-  [Function `get_beneficiary_for_operator`](#0x1_stake_get_beneficiary_for_operator)
...
-  [Function `set_beneficiary_for_operator`](#0x1_stake_set_beneficiary_for_operator)
...
<a name="0x1_stake_Beneficiary"></a>

## Resource `Beneficiary`



<pre><code><b>struct</b> <a href="stake.md#0x1_stake_Beneficiary">Beneficiary</a> <b>has</b> key
</code></pre>
...
<a name="0x1_stake_get_beneficiary_for_operator"></a>

## Function `get_beneficiary_for_operator`

Return the operator of the validator at <code>pool_address</code>.


<pre><code>#[view]
<b>public</b> <b>fun</b> <a href="stake.md#0x1_stake_get_beneficiary_for_operator">get_beneficiary_for_operator</a>(pool_address: <b>address</b>): <b>address</b>
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="stake.md#0x1_stake_get_beneficiary_for_operator">get_beneficiary_for_operator</a>(pool_address: <b>address</b>): <b>address</b> <b>acquires</b> <a href="stake.md#0x1_stake_StakePool">StakePool</a>, <a href="stake.md#0x1_stake_Beneficiary">Beneficiary</a> {
    <a href="stake.md#0x1_stake_assert_stake_pool_exists">assert_stake_pool_exists</a>(pool_address);
    <b>if</b>(<b>exists</b>&lt;<a href="stake.md#0x1_stake_Beneficiary">Beneficiary</a>&gt;(pool_address)) {
        <b>borrow_global</b>&lt;<a href="stake.md#0x1_stake_Beneficiary">Beneficiary</a>&gt;(pool_address).beneficiary
    } <b>else</b> {
        <b>borrow_global</b>&lt;<a href="stake.md#0x1_stake_StakePool">StakePool</a>&gt;(pool_address).operator_address
    }
}
...
<a name="0x1_stake_set_beneficiary_for_operator"></a>

## Function `set_beneficiary_for_operator`



<pre><code><b>public</b> <b>fun</b> <a href="stake.md#0x1_stake_set_beneficiary_for_operator">set_beneficiary_for_operator</a>(pool_signer: &<a href="../../aptos-stdlib/../move-stdlib/doc/signer.md#0x1_signer">signer</a>, new_beneficiary: <b>address</b>)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="stake.md#0x1_stake_set_beneficiary_for_operator">set_beneficiary_for_operator</a>(pool_signer: &<a href="../../aptos-stdlib/../move-stdlib/doc/signer.md#0x1_signer">signer</a>, new_beneficiary: <b>address</b>) <b>acquires</b> <a href="stake.md#0x1_stake_Beneficiary">Beneficiary</a> {
    <b>let</b> pool_address = <a href="../../aptos-stdlib/../move-stdlib/doc/signer.md#0x1_signer_address_of">signer::address_of</a>(pool_signer);
    <a href="stake.md#0x1_stake_assert_stake_pool_exists">assert_stake_pool_exists</a>(pool_address);
    <b>if</b> (!<b>exists</b>&lt;<a href="stake.md#0x1_stake_Beneficiary">Beneficiary</a>&gt;(pool_address)) {
        <b>move_to</b>(pool_signer, <a href="stake.md#0x1_stake_Beneficiary">Beneficiary</a> { beneficiary: new_beneficiary });
    }
    <b>else</b> {
        <b>let</b> beneficiary = <b>borrow_global_mut</b>&lt;<a href="stake.md#0x1_stake_Beneficiary">Beneficiary</a>&gt;(pool_address);
        beneficiary.beneficiary = new_beneficiary;
    }
    // TODO: emit an <a href="event.md#0x1_event">event</a>
}
</code></pre>
